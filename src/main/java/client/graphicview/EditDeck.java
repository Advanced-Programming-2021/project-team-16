...
//        String message = client.controller.DeckMenu.addCardToDeck(selected.getName(), deck[0].trim(), true);
...
//        String message = client.controller.DeckMenu.addCardToDeck(selected.getName(), deck[0].trim(), false);
//        if (!message.equals("there are already three cards with name " + "\"" + selected.getName() + "\"" + " in deck " + "\"" + deck[0].trim() + "\"")) {
//            addCardBoard();
//        } else errorTxt.setText(message);
//    }
...
//        String message = client.controller.DeckMenu.removeCardFromDeck(selected.getName(), deck[0].trim(), isMain);
...
//    }
    ...
    public void setActiveBtnOnAction(ActionEvent actionEvent) {
        String message = client.controller.DeckMenu.activate(deck[0].trim());
...
//    }
    ...
    public void deleteBtnOnAction(ActionEvent actionEvent) {
        String message = client.controller.DeckMenu.delete(deck[0].trim());
