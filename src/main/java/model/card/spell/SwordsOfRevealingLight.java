...
public class SwordsOfRevealingLight extends Spell {
    ...
    public SwordsOfRevealingLight() {
        super("Swords of Revealing Light", "Spell", SpellType.NORMAL
                , "After this card's activation, it remains on the field, but destroy it during the End Phase" +
                        " of your opponent's 3rd turn. When this card is activated: If your opponent controls a face-down monster, flip all monsters they control face-up." +
