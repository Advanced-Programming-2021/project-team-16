...
import server.modell.card.spell.MessengerOfPeace;
...
//
//    private static gameServer currentGame;
//    public static void duel(User user2, int round) {
//        Player player1 = new Player(getCurrentUser());
//        Player player2 = user2 == null ? new AI() : new Player(user2);
//        boolean doesFirsPlayerStart = (new Random()).nextBoolean();
//        if (doesFirsPlayerStart) setCurrentGame(new gameServer(player1, player2, round));
//        else setCurrentGame(new gameServer(player2, player1, round));
...
//        //}
//    }
//    public gameServer(Player player1, Player player2, int round) {
//        this.currentPlayer = player2;
//        this.rival = player1;
//        rival.setRival(currentPlayer);
//        currentPlayer.setRival(rival);
//        this.round = round;
//    }    public static void setCurrentGame(gameServer currentGame) {
//        gameServer.currentGame = currentGame;
//    }
...
//   }
    ...
    public String summon() {
        ...
        int numberOfTributes = switch (selectedCard.getLevel()) {
            case 5, 6 -> 1;
            case 7, 8, 9 -> 2;
            default -> 0;
        };
      ...
      //        GameView.hideNode(card);
        switch (zone) {
            ...
            case FIELD_SPELL -> {
                ...
                if (card != null) putCardInZone(card, Board.Zone.GRAVE, null, board);
            }
