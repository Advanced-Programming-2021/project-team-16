...
import server.model.card.spell.fieldspells.ClosedForest;
...
public class UpdateStatus {
    ...
    public static void makeAllMonsters() {
        ...
        new Monster("Flamemanipulator", "This Spellcaster attacks enemies with fire-related spells such" +
                ...
                , 900, 1000);
        new Monster("Blue-Eyeswhitedragon", "This legendary dragon is a powerful engine of destruction." +
        ...
        new RitualMonster("SkullGuardian", "This monster can only be Ritual Summoned with the Ritual " +
                ...
                2500, Card.getCardByName("NovoxsPrayer"));
        new RitualMonster("CrabTurtle", "This monster can only be Ritual Summoned with the Ritual Spell " +
                ...
                Card.getCardByName("TurtleOath"));
        new Monster("SlotMachine", "The machine's ability is said to vary according to its slot results."
        ...
        new TheCalculator();
        new Monster("AlexandriteDragon", "Many of the czars' lost jewels can be found in the scales of" +
        ...
        new GraveYardEffectMonster("ExploderDragon", "If this card is destroyed by battle and sent to the" +
        ...
        new Terratiger();
        new TheTricky();
        new Monster("SpiralSerpent", "When huge whirlpools lay cities asunder, it is the hunger of this " +
